...
Route::get('/dashboard/total/skipetudiante/mm/{yy}',[DashboardController::class,'totalSkipStudentByMM']);
Route::get('/dashboard/total/newetudiante/mm/{yy}',[DashboardController::class,'totalNewStudentByMM']);
