...
Route::get('/dashboard/total/skipetudiante/mm',[DashboardController::class,'totalSkipStudentByMM']);
Route::get('/dashboard/total/newetudiante/mm',[DashboardController::class,'totalNewStudentByMM']);
